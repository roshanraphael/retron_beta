    ...
    <>
      ...
      <div className="container-fluid bg-white pt-5" style={{ width: "100%" }}>
        <div className="row p-5" style={{ height: "500px" }}>
          <div
            className="col-sm d-flex justify-content-center align-item-center"
            data-aos="fade-up"
            data-aos-delay="400"
          >
            <div
              className="col-sm order-lg-first content-center img-fluid"
              style={{
                backgroundImage:
                  "url(" +
          ...
          <div
            className="col d-flex justify-content-center align-item-center"
            data-aos="fade-up"
            data-aos-delay="600"
          >
            <Login />
